...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="/resource/admin"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="/resource/admin/users">Usuários</a></li>
    <li class="active"><a href="/resource/admin/users/create">Cadastrar</a></li>
  </ol>
</section>
